        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/about" className="text-gray-400 hover:text-indigo-400 transition">
                  À propos
                </a>
              </li>
              <li>
                <a href="/projects" className="text-gray-400 hover:text-indigo-400 transition">
                  Projets
                </a>
              </li>
              <li>
                <a href="/contact" className="text-gray-400 hover:text-indigo-400 transition">
                  Contact
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-indigo-600 transition-all hover:scale-110"
              >
